...
public class JobEntryDebugLevelDialog extends Dialog {
  private static Class<?> PKG = JobEntryDebugLevelDialog.class; // for i18n purposes, needed by Translator2!!

  private JobEntryDebugLevel input;
  private JobEntryDebugLevel debugLevel;
  ...
  public JobEntryDebugLevelDialog( Shell par, JobEntryDebugLevel debugLevel) {
    super( par, SWT.NONE );
  ...
  public boolean open() {
    ...
    shell.setText( "Job entry debug Level" );
    ...
    BaseStepDialog.positionBottomButtons( shell, buttons, margin*2, lastControl );
  ...
  private void getInfo( JobEntryDebugLevel level ) {
